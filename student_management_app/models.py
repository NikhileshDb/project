...
class Students(models.Model):
    ...
    profile_pic = models.FileField(upload_to='profile/%Y/%m/%d')
    address = models.TextField()
...
class Notice(models.Model):
    ...
    is_featured = models.CharField(max_length=10, default= 'False', choices=BOOL_CHOICES, null=True)
    def __str__(self):
        return self.title
...
class Events(models.Model):
    ...
    featured_image = models.ImageField(upload_to='events/%Y/%m/%d',null=True)
...
class HeroCarousal(models.Model):
    alt_text = models.CharField(max_length=200, null = True)
    carousal_image = models.ImageField(upload_to ='banner/', null=True)
    url_link = models.URLField(null = True)
    status = models.CharField(max_length=15, choices = IMAGE_STATUS, default = 'Not Featured')
